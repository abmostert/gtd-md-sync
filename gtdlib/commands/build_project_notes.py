...
def ensure_project_notes_for_project(base_dir: Path, pid: str, project: dict, actions: dict) -> Path | None:
    ...
    lines.append("")
    lines.append("STANDARD NEXT ACTION EXAMPLE:")
    lines.append("")
    ...
    lines.append("")
    lines.append("WAITING FOR EXAMPLE:")
    lines.append("")
    lines.append("- [ ] draft: Example waiting-for item")
    lines.append("  - waiting_for: Person or organisation")
    lines.append("  - due: 2026-02-22")
    lines.append("  - notes: optional notes")
    lines.append("")
    lines.append("AGENDA EXAMPLE:")
    lines.append("")
    lines.append("- [ ] draft: Example agenda item")
    lines.append("  - context: Person or meeting name")
    lines.append("  - due: 2026-02-22")
    lines.append("  - notes: optional notes")
    lines.append("")
    lines.append("SOMEDAY EXAMPLE:")
    lines.append("")
    lines.append("- [ ] draft: Example someday/maybe item")
    lines.append("  - context: work")
    lines.append("  - notes: optional notes")
    lines.append("")
    lines.append("For agenda items, 'context' means the person or meeting target.")
    lines.append("")
